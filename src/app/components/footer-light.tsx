            ...
            <div className="row">
                ...
                <div className="col-12 col-md-5 col-lg-12 col-xl-4">
                    <div className="footer-widget pe-xl-4 mb-5">
                        ...
                        <div className="footerText"><p>© {new Date().getFullYear()} KenyaBizzDirectory. Develop with <FaHeart className="ms-1 text-danger"></FaHeart>  By <Link href="https://shreethemes.in/" target="_blank">Shreethemes</Link></p></div>
                ...
                <div className="col-6 col-md-4 col-lg-3 col-xl-2">
                    <div className="footer-widget">
                        <h4 className="widget-title">KenyaBizzDirectory Business</h4>
                        <ul className="footer-menu">
                            {/* @ts-ignore */}
